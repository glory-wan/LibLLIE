...
class KinDPlusPlus(LLIEModel):
    """KinD++ model for_teach low-light enhancement beyond brightening.

    Original paper: https://doi.org/10.1007/s11263-020-01407-x
    Official source code: https://github.com/zhangyhuaee/KinD_plus
    Official project url: None

    KinD++ improves KinD with a multi-scale illumination attention module (MSIA)
    in the reflectance restoration network to reduce non-uniform spots and
    over-smoothing.
    """
